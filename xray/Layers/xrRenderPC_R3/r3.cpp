	...
	void*&							result)
{
	...
	if (RImplementation.o.advancedpp && ps_r2_ls_flags_ext.test(R2FLAGEXT_TONEMAP_PASS))
	{
		defines[def_it].Name		=	"USE_TONEMAP_PASS";
		defines[def_it].Definition	=	"1";
		def_it						++;
		sh_name[len]='1'; ++len;
	}
	...
	if (RImplementation.o.advancedpp && ps_r2_ls_flags_ext.test(R2FLAGEXT_FILM_GRAIN))
	{
	...
	if (RImplementation.o.advancedpp && ps_r2_ls_flags_ext.test(R2FLAGEXT_VIGNETTE))
	{
	...
	if (RImplementation.o.advancedpp && ps_r2_ls_flags_ext.test(R2FLAGEXT_CHROMATIC_ABBERATION))
	{
	...
	if (RImplementation.o.advancedpp && ps_r2_ls_flags_ext.test(R2FLAGEXT_LENSFLARES))
	{
   ...
   if( o.dx10_msaa )
   {
	...
	xr_strcpy		( folder, "r3\\objects\\r3_new\\" );
