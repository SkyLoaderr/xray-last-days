...
Flags32		ps_r2_ls_flags_ext			= {
		...
		|R2FLAGEXT_ENABLE_TESSELLATION | R2FLAGEXT_TRUE_SHADOWS
	};
...
float		ps_r2_ls_tonemap_intensity	= 1.f;
float		ps_r2_ls_vignette_intensity	= 1.f;
float		ps_r2_ls_abberation_amount	= 0.002f;
float		ps_r2_ls_lensflares_intensity = 1.f;
...
//	CMD3(CCC_Mask,		"r2_sun_shafts",				&ps_r2_ls_flags,			R2FLAG_SUN_SHAFTS);
	...
	CMD3(CCC_Mask,		"r2_tonemap_enable",			&ps_r2_ls_flags_ext,		R2FLAGEXT_TONEMAP_PASS);
	CMD4(CCC_Float,		"r2_tonemap_intensity",			&ps_r2_ls_tonemap_intensity, 0.0f, 1.0f);

	CMD3(CCC_Mask,		"r2_filmgrain_enable",			&ps_r2_ls_flags_ext,		R2FLAGEXT_FILM_GRAIN);

	CMD3(CCC_Mask,		"r2_vignette_enable",			&ps_r2_ls_flags_ext,		R2FLAGEXT_VIGNETTE);
	CMD4(CCC_Float,		"r2_vignette_intensity",		&ps_r2_ls_vignette_intensity, 0.0f, 1.0f);

	CMD3(CCC_Mask,		"r2_chromatic_abberation_enable",&ps_r2_ls_flags_ext,		R2FLAGEXT_CHROMATIC_ABBERATION);
	CMD4(CCC_Float,		"r2_chromatic_abberation_amount",	&ps_r2_ls_abberation_amount, 0.001f, 0.004f);

	CMD3(CCC_Mask,		"r2_lensflares_enable",			&ps_r2_ls_flags_ext,		R2FLAGEXT_LENSFLARES);
	CMD4(CCC_Float,		"r2_lensflares_intensity",		&ps_r2_ls_lensflares_intensity, 0.0f, 1.0f);


	CMD3(CCC_Mask,		"r2_shoc_env_calc",				&ps_r2_ls_flags_ext,		R2FLAGEXT_SHOC_ENV_CALC);
	CMD3(CCC_Mask,		"r__true_shadows",				&ps_r2_ls_flags_ext,		R2FLAGEXT_TRUE_SHADOWS);
