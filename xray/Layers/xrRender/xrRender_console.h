...
extern ECORE_API float			ps_r2_ls_tonemap_intensity;		// 1.f;
extern ECORE_API float			ps_r2_ls_vignette_intensity;	// 1.f;
extern ECORE_API float			ps_r2_ls_abberation_amount;		// 0.002f;
extern ECORE_API float			ps_r2_ls_lensflares_intensity;	// 1.f;
...
enum
{
	...
	R2FLAGEXT_TONEMAP_PASS			= (1<<10),
	R2FLAGEXT_FILM_GRAIN			= (1<<11),
	R2FLAGEXT_VIGNETTE				= (1<<12),
	R2FLAGEXT_TRUE_SHADOWS			= (1<<13),
	R2FLAGEXT_SHOC_ENV_CALC			= (1<<14),
	R2FLAGEXT_CHROMATIC_ABBERATION	= (1<<15),
	R2FLAGEXT_LENSFLARES			= (1<<16),
};
