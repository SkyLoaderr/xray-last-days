...
Flags32			psActorFlags={AF_GODMODE_RT|AF_AUTOPICKUP|AF_RUN_BACKWARD|AF_IMPORTANT_SAVE|AF_ACTOR_SHADOW};
...
//			Msg( "bs            = %.2f", bs );
	...
	{
		BOOL bVisible = !HUDview() || (psActorFlags.test(AF_ACTOR_SHADOW) && psDeviceFlags.test(rsR2 | rsR3 |rsR4));
		setVisible				(bVisible);
	}
