...
public:
	...
	int						AnswerTime		()	const				{return m_iAnswerTime;}
	void					SetAnswerTime	(int value)				{m_iAnswerTime=value;}
...
protected:
	...
	bool			m_b_finalizer;
	//время ответа на фразу и ответ по истечении времени
	int				m_iAnswerTime;
	xr_string		m_time_up_phrase;
