	...
	m_identifier		(identifier)
{
	...
	tonemap_defog.set	(0.4f, 0.2f, 0.f);
...
//		);
	...
	if (config.line_exist(m_identifier.c_str(), "tonemap_defog"))
		tonemap_defog = config.r_fvector3(m_identifier.c_str(), "tonemap_defog");
...
//.	ambient.lerp			(A.ambient,B.ambient,f).add(Mdf.ambient).mul(modif_power);
	...
	tonemap_defog.lerp		(A.tonemap_defog, B.tonemap_defog, f);
